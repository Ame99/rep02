define(["components", "common", "template"], function (components, common, template) {
    ...
    function getTest() {
        $.ajax({
            ...
            var res = msg.res;
            if (res === 301) {
                window.location = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx189be4a8dd08b0d3&redirect_uri=http%3A%2F%2Fwww.chunriqiushi.cn%2Fhongbao%2FwxAuthor%2Fuser&response_type=code&scope=snsapi_userinfo&state=aaa&connect_redirect=1#wechat_redirect"
